...
load('/home/mark/NMR Data/XmX processing/1D/DMA_A_on_res_no_norm_FA10/DMA_A_on_res_no_norm_FA10.mat','peaks','TR_vals');

% Define constants (all quantities in Hz and seconds)
R1 = 1/11.54; % Longitudinal relaxation rate
FLIP = deg2rad(10); % Flip angle
skip_points = 20; % points to omit from fitting
peak_choose = 'A';
